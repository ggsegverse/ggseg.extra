...
The cortical pipeline projects inflated mesh triangles directly to 2D polygons — atlas creation takes seconds and needs only FreeSurfer to read annotation files, with no rendering step.
