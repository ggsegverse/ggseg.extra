...
It downloads the [ggseg-atlas-template](https://github.com/ggsegverse/ggseg-atlas-template)
from GitHub and customises it for your atlas. The result includes tests, GitHub Actions
workflows, pkgdown configuration, and the general structure we expect from a ggseg-atlas package.
If you already make R packages comfortably, you can also use the template repository directly on GitHub.
...
Go to [source repository for r-universe setup](https://github.com/ggsegverse/ggsegverse.r-universe.dev) and fork the repository.
