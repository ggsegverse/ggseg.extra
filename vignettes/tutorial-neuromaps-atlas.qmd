...
The pipeline returns raw polygons; call `atlas_simplify()` and `atlas_smooth()` afterwards to balance clarity and file size.
We start with 7 bins and then simplify to roughly 20% of vertices:
