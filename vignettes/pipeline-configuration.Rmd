...
sf simplification has moved out of atlas creation entirely — call `atlas_simplify()` on the returned atlas instead.
...
Use `atlas_simplify()` on the returned atlas to control the trade-off between detail and file size.
