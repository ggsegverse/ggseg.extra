...
- **`tolerance`** controls vertex simplification in the output polygons.
  Higher values mean simpler polygons with fewer vertices. Default is
  0.5; use 0 for maximum fidelity.
